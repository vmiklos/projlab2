...
\begin{figure}[H]
\includegraphics[width=100mm,keepaspectratio]{testarch.eps}
\end{figure}
\begin{itemize}
...
\begin{columns}[c]
\column{1.5in}
\framebox{\includegraphics[width=35mm,keepaspectratio]{setup1.eps}}
\framebox{\includegraphics[width=35mm,keepaspectratio]{setup2.eps}}
\framebox{\includegraphics[width=35mm,keepaspectratio]{setup3.eps}}
\column{1.5in}
\framebox{\includegraphics[width=35mm,keepaspectratio]{setup4.eps}}
\framebox{\includegraphics[width=35mm,keepaspectratio]{setup5.eps}}
\end{columns}
\end{frame}
